...
export default function DashboardStats({ userId }) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
      {[...Array(6)].map((_, i) => (
        <div key={i} className="card-glass animate-pulse bg-white/30 border-white/30">
          <div className="h-4 bg-gray-300/60 rounded mb-2"></div>
          <div className="h-8 bg-gray-300/60 rounded mb-1"></div>
    ...
    {statCards.map((stat, index) => (
      ...
      >
        <div className="flex items-center justify-between mb-2">
          <div className={`p-2 rounded-lg ${stat.bgColor} shadow-glow`}>
